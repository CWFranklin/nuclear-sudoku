...
$(function () {
    ...
    socket.on('startCountdown', function (delay) {
        ...
        for (var i in cities) cities[i].setMap(null);
        for (var i in clouds) clouds[i].setMap(null);
        for (var i in paths) paths[i].setMap(null);
    ...
    socket.on('playerLeft', function (data) {
        ...
        if (cities[data.player]) cities[data.player].setMap(null);
    });
